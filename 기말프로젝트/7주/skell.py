...
class Skell:
    ...
    def __init__(self):
        ...
        self.targets = []
        if Skell.image == None:
            Skell.image = gfw.image.load('res/Skeleton.png')
...
class Skell2:
    ...
    def __init__(self):
        ...
        if Skell2.image == None:
            Skell2.image = gfw.image.load('res/Skeleton.png')
...
class St2Skell:
    ...
    def __init__(self):
        ...
        if St2Skell.image == None:
            St2Skell.image = gfw.image.load('res/Skeleton.png')
...
class St2Skell1:
    ...
    def __init__(self):
        ...
        if St2Skell1.image == None:
            St2Skell1.image = gfw.image.load('res/Skeleton.png')
...
class St2Skell2:
    ...
    def __init__(self):
        ...
        if St2Skell2.image == None:
            St2Skell2.image = gfw.image.load('res/Skeleton.png')
